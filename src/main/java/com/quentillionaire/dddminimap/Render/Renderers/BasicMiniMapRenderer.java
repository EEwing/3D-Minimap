...
public class BasicMiniMapRenderer extends MiniMapRenderer {
    ...
    private void drawTestThing() {
        float f = 1F / scale;

        Tessellator tessellator = Tessellator.instance;
        tessellator.startDrawingQuads();
            tessellator.setNormal(f,f,0);

            /*tessellator.addVertexWithUV(0,0,0,f,f);
            tessellator.addVertexWithUV(0,1,0,f,f);
            tessellator.addVertexWithUV(1,1,0,f,f);
            tessellator.addVertexWithUV(1,0,0,f,f);*/
